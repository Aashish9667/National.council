...
export default function Page14() {
  return (
    <div
      className="md:w-full h-[585px] md:h-[490px] flex justify-center items-center px-4 md:px-8 md:mt-29 mt-20 relative"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between w-full max-w-[1200px] relative h-full md:gap-x-4">
        ...
        <div className="flex flex-col md:w-[52%] text-center md:text-left justify-center h-full md:ml-5">
          <h1 className="text-[25px] md:text-[34px] text-[#1D3D76] font-bold md:mb-1 md:mt-0 mb-1 mt-10">
        ...
        {/* Right Side Image */}
        <div className="relative w-full md:w-[48%] flex justify-end  h-full md:ml-0 ml-15">
          <img
            src="/1.png"
            alt="educated"
  className="absolute bottom-0 w-[130%] sm:w-full md:w-auto max-w-[800px] md:max-w-[700px] object-contain"
          />

          {/* Vertical Right Button */}
              <button className=" absolute right-2 md:-right-8 bottom-80 bg-orange-500 text-white px-2  py-1 rounded-b-lg rotate-90 hover:bg-orange-600 shadow-lg">
