...
export default function Page14() {
  return (
    <div
      className="w-full h-[600px] flex justify-center items-center px-4 md:px-8 relative"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between w-full max-w-[1200px] relative h-full md:gap-x-4">
        ...
        <div className="flex flex-col md:w-[52%] text-center md:text-left justify-center h-full md:ml-5">
          <h1 className="text-[25px] md:text-[34px] text-[#1D3D76] font-bold md:mb-1 md:mt-20">
          ...
          <div className="bg-[#1D3D76] w-fit  rounded-lg mt-3 md:mb-10 text-left">
            <h1 className="text-white p-2 text-sm md:text-base font-bold px-14 py-1 text-left">
              From nurturing roots to creating a worldwide impact.
            </h1>
          </div>

          <div className="bg-yellow-400 rounded-[20px] w-fit mx-auto md:mx-0 md:mt-2">
