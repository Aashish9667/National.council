      ...
      <div className="flex flex-col md:flex-row justify-between w-full max-w-[1200px] relative h-full md:gap-x-4">
        ...
        <div className="flex flex-col md:w-[52%] text-center md:text-left justify-center h-full md:ml-5">
          ...
          <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
            <div className=" mb-10 w-[75px] h-[75px] border-2 border-black rounded-full flex items-center justify-center">
              <Pause size={43} className="text-black" />
            </div>
             <h1
              className="text-[36px] md:text-[64px] font-bold text-[#1d3d76] md:leading-12"
              style={{ fontFamily: '"Myriad Pro", sans-serif' }}
            >
              Paused <br /> <span className="italic text-[#1D3D76] text-[40px] ">your</span>{" "}
              <span className="bg-yellow-400 px-1 rounded text-[40px] ">studies?</span>
            </h1>
          </div>

          {/* Play line */}
          <div className="flex items-center justify-center md:justify-start gap-3">
            <div className="w-[45px] h-[45px] border-2 border-black rounded-md flex items-center justify-center">
              <Play size={24} className="text-black" />
            </div>
            <p
              className="text-[20px] md:text-[35px] font-bold  bg-gradient-to-r from-[#E64622] to-[#1D3D76] text-transparent bg-clip-text"
              style={{ fontFamily: '"Myriad Pro", sans-serif' }}
            >
