      ...
      <div className="flex flex-col md:flex-row justify-between w-full max-w-[1200px] relative h-full md:gap-x-2">
        ...
        <div className="relative w-full md:w-[47%] flex justify-end h-full">
          <img
            src="/5.png"
            alt="educated"
            className="absolute bottom-0 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 w-full md:w-auto max-w-[700px] md:max-w-[600px] max-h-[970px] object-contain md:-ml-0 -ml-3"
          />
